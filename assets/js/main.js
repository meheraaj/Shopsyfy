                                ...
                                <div class="product__wrapper mb-16">
                                    <div class="product__thumb">
                                        ...
                                        <div class="product__action transition-3">
                                             <button  data-bs-toggle="tooltip" data-placement="top" class='addtowishlist' data-product='${JSON.stringify(
                                               p
                                             ).replace(/'/g, "&apos;")}'
                                                title="Add to Wishlist">
                                                <i class="fal fa-heart"></i>
                                            </button>
                                            <button  data-bs-toggle="tooltip" data-placement="top" title="Compare">
                                                <i class="fal fa-sliders-h"></i>
                                            </button>
                                            <button data-bs-toggle="modal" data-bs-target="#productModalId">
